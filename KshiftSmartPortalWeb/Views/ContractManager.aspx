<%@ Page Title="계약정보 관리" Language="C#" MasterPageFile="~/Views/Site.Master" AutoEventWireup="true" 
    CodeBehind="ContractManager.aspx.cs" Inherits="KShiftSmartPortalWeb.ContractManager" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="search-panel">
        ...
        <div class="search-row">
            ...
            <div class="search-item">
                <dx:ASPxCheckBox ID="chkSelectAll" runat="server" 
                    Text="전체 조회"
                    Checked="true">
                </dx:ASPxCheckBox>
            </div>
        ...
        <div class="search-row" style="margin-top: 15px;">
            <!-- Company 구분 -->
            <div class="search-item">
                <label><i class="fas fa-building"></i> Company 구분:</label>
            ...
            <!-- Company -->
            <div class="search-item">
                <label><i class="fas fa-industry"></i> Company:</label>
            ...
            <!-- 케이스 -->
            <div class="search-item">
                <label><i class="fas fa-folder"></i> 케이스:</label>
        ...
        <div class="search-row" style="margin-top: 15px;">
            <!-- 계약일 (시작) -->
            <div class="search-item">
                <label><i class="fas fa-calendar"></i> 계약일 (시작):</label>
            ...
            <!-- 계약일 (종료) -->
            <div class="search-item">
                <label><i class="fas fa-calendar"></i> 계약일 (종료):</label>
                <dx:ASPxDateEdit ID="dtEndDate" runat="server" 
                    Width="150px"
                    DisplayFormatString="yyyy-MM-dd"
                    EditFormat="Date"
                    AllowNull="false">
    ...
    <div class="grid-container">
        <div class="grid-header">
            <i class="fas fa-table"></i> 계약 목록
        </div>
        
        <dx:ASPxGridView ID="gridContracts" runat="server" 
            Width="100%" 
